...
export async function sendEvaltreeThankYouEmail(opts: {
  ...
  const res = await fetch("https://api.brevo.com/v3/smtp/email", {
    ...
    body: JSON.stringify({
      sender: { name: senderName, email: senderEmail },
      to: [{ email: to }],
      subject: "Thank you for your purchase of Evaltree Insights",
      htmlContent: `
  <div style="margin:0;padding:0;background:#F5F6F8;">
    <table role="presentation" width="100%" cellpadding="0" cellspacing="0" style="background:#F5F6F8;padding:24px 0;">
      <tr>
          ...
          <table role="presentation" width="600" cellpadding="0" cellspacing="0"
            ...
            <tr>
              <td style="padding:26px 24px 22px 24px;">
                <div style="font-family:Inter,Arial,sans-serif;color:#0F1C3F;line-height:1.7;font-size:14px;">
                  ...
                  <p style="margin:0 0 14px 0;">
                    We’re writing to let you know that your selected brief(s) are currently undergoing final compliance and quality verification.
                    This is part of our commitment to ensuring that all Evaltree content meets required legal, licensing, and disclosure standards.
                  </p>

                  <p style="margin:0 0 14px 0;">
                    Your brief(s) will be delivered to you shortly.<br/>
                    No action is required from your side.
                  </p>

                  <p style="margin:0 0 14px 0;">
                    If you have any questions in the meantime, you can reach us at
                    <a href="mailto:support@crowbarltd.com" style="color:#0F1C3F;text-decoration:underline;">
