...
export default function ThankYouPage() {
  ...
  function startDownload() {
    // ✅ always use paid-download so it never asks to pay again
  ...
  useEffect(() => {
    (async () => {
      try {
        ...
        // ✅ Auto-download only once after successful verify
      ...
      <div className="mx-auto max-w-4xl px-6 py-10">
        <div className="rounded-3xl bg-white p-8 shadow-sm md:p-10">
          ...
          <p className="mt-3 text-base opacity-80">
            Your PDF download will start automatically. If it doesn’t, use the button below.
          </p>
          ...
          <div className="mt-6 rounded-2xl border border-[#0F1C3F]/10 bg-[#F5F6F8] p-5">
            ...
            <p className="mt-2 text-sm opacity-80">
              A purchase confirmation and download access is sent to your email after payment.
              Please check spam/junk as well.
            </p>
          </div>

          {/* Compliance disclaimers (kept consistent) */}
